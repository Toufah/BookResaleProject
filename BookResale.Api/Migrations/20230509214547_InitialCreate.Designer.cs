...
namespace BookResale.Api.Migrations
{
    ...
    [Migration("20230509214547_InitialCreate")]
            ...
            modelBuilder.Entity("BookResale.Api.Entities.Book", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AuthorId = 1,
                            CategoryId = 2,
                            Description = "A classic personal finance book written by George S. Clason. The book uses parables set in ancient Babylon to teach timeless lessons about money management and wealth creation.",
